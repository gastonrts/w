...
void mostrarEmpladosxsector (eEmpleado empleados[], int tam, eSector sectores[], int tamSector );
...
int main()
{
    ...
    do
    {
        ...
        case 6:
          ...
          /*  mostrarEmpladosxsector(empleados,TAM,sectores,5);
            system("pause");*/
...
int menu()
{
    ...
    printf(" 6- Ordenar Empleados por Sector\n");
    printf(" 10- Salir\n\n");
...
//void mostrarEmpladosxsector (eEmpleado empleados[], int tam, eSector sectores[], int tamSector )
//falta terminar
// La documentacion va en el doc.h/*
